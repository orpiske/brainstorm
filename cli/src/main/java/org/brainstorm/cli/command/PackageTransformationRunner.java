...
public class PackageTransformationRunner extends PackageWorker {
    @CommandLine.Option(names = {"--base-image"}, description = "The default base image", defaultValue = "quay.io/bstorm/runner-worker:latest", arity = "0..1")
    protected String baseImage;

    @CommandLine.Option(names = {"--output-image"}, description = "The default base image", defaultValue = "quay.io/bstorm/runner-worker-layered:latest", arity = "0..1")
